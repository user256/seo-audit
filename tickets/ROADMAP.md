...
1. [Ticket 407](./407-cannyforge-visual-reskin.md) — merged; needs only the
   user's light/dark visual smoke check.
2. [Ticket 408](./408-theme-a11y-fidelity.md) — accessibility gaps found in the
...
- Sprint 1 implementation + remediations 100–115, plus
  [116](./completed/116-flaky-collect-dom-timeout.md) (suite determinism):
  [completed/](./completed/).
